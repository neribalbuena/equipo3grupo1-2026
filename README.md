...
* **Avance real actual:** ~25% del total.
* Ya contamos con la base de datos estructurada, la conexión inicial programada, el frontend con la captura de eventos y el diseño de la interfaz del tótem totalmente renovado.
*